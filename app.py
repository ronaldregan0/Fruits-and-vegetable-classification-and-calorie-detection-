...
Food = load_model(r"C:\Users\91827\OneDrive\Desktop\ML_work\Food Clasification\module 3-20240228T080816Z-001\module 3\Application\model files\Indian_food_20.h5")
fre = load_model(r"C:\Users\91827\OneDrive\Desktop\ML_work\Food Clasification\module 3-20240228T080816Z-001\module 3\Application\model files\Food_freshness.h5")

# Load the PyTorch model for fruit and vegetable detection
model = AutoModelForImageClassification.from_pretrained(r"C:\Users\91827\Downloads\Fruits_veggies_detection")
...
# Your API key
API_KEY_nutrition = '9S+NWmHVRTjvvzwWSpshVA==XWMo7sRyGP3eejiC'
...
def get_nutrition_info():
    if request.method == 'POST':
        ...
        response = requests.get(api_url, headers={'X-Api-Key': API_KEY_nutrition})
        ...
        if response.status_code == requests.codes.ok:
            ...
            if nutrition_info:
                return render_template('nutrition_info.html', nutrition_info=nutrition_info)
            else:
